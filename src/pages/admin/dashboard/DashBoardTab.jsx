...
function DashboardTab() {
  ...
  const { mode, product, handleEdit, deleteProduct,order ,user} = context;
  ...
  const add = () => {
    console.log("add chala in AddpOrdutckjfkjsbfkjs");
      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            ...
            {/* product  */}
            <TabPanel>
              <div className="  px-4 md:px-0 mb-16 mx-5">
                <h1
                            ...
                            <td className="px-6 py-4">
                              <div className=" flex gap-2">
                                ...
                                >
                                  ...
                                  <Link to='/updateproduct'  onClick={()=>handleEdit(pro)}>
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-16 mx-5">
                <h1
                  className=" text-center mb-5 text-3xl font-semibold underline"
                  style={{ color: mode === "dark" ? "white" : "" }}
                >
                ...
                {order.map((allOrder,index)=>{
                  ...
                  <tbody>
                    ...
                    {allOrder.cartItems.map((ord,index)=>
                    {const {title,description,category,imageUrl,price} = ord;
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-10 mx-5">
                <h1
                  className=" text-center mb-5 text-3xl font-semibold underline"
                  style={{ color: mode === "dark" ? "white" : "" }}
                >
